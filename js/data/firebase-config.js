      ...
      if (data) {
        ...
        const templatesSeed = [
          { id: 'template-co2-mag', name: 'CO2/MAG Robot Template', items: [
            { id: 1, title: 'Clean welder rear filter', title_en: 'Clean Welder Rear Filter', title_jp: '溶接機裏側のフィルター清掃', desc: 'Remove rear filter and blow out dust with compressed air to prevent overheating.', desc_en: 'Remove rear filter and blow out dust with compressed air to prevent overheating.', desc_jp: 'パワーソース（溶接電源）裏側のフィルターを取り外し、粉塵をエアーブローして過熱エラーを防止する。', freq: 'monthly', image: 'image1.jpeg', category: 'A' },
            ...
            { id: 3, title: 'Test emergency stop button', title_en: 'Test Emergency Stop Button', title_jp: '非常停止ボタンの作動確認', desc: 'Ensure teach pendant, cabinet e-stops, and gate interlocks halt the robot immediately.', desc_en: 'Ensure teach pendant, cabinet e-stops, and gate interlocks halt the robot immediately.', desc_jp: 'ティーチペンダントおよび制御盤の非常停止ボタン、または安全柵のドアインターロックが開いた際にロボットが即座に停止するかテストする。', freq: 'monthly', image: 'image4.jpeg', category: 'A' },
            { id: 4, title: 'Check welding ground cable', title_en: 'Check Welding Ground Cable', title_jp: '溶接アース接続部の緩み・腐食点検', desc: 'Inspect grounding clamps and table connections for looseness or spatter buildup.', desc_en: 'Inspect grounding clamps and table connections for looseness or spatter buildup.', desc_jp: '定盤や冶具へのアースクランプ・アース線の接続状態を点検し、緩みやスパッタの付着がなく確実に固定されているか確認する。', freq: 'monthly', image: 'generic-check.png', category: 'A' },
            ...
            { id: 7, title: 'Sand & oil welding table', title_en: 'Sand & Oil Welding Table', title_jp: '定盤・溶接台の清掃（研磨・防錆油塗布）', desc: 'Remove spatter with a grinder and apply anti-rust oil to the welding table.', desc_en: 'Remove spatter with a grinder and apply anti-rust oil to the welding table.', desc_jp: '溶接定盤の表面に付着したスパッタをグラインダー等で研磨して除去し、清掃後、防錆油を塗布する。', freq: 'monthly', image: 'generic-check.png', category: 'A' },
            { id: 8, title: 'Clean conduit hose inner liner', title_en: 'Clean Conduit Hose Inner Liner', title_jp: 'コンジットホース内のアルコール清掃', desc: 'Flush the inner liner with alcohol and blow compressed air to remove copper dust.', desc_en: 'Flush the inner liner with alcohol and blow compressed air to remove copper dust.', desc_jp: '送給装置のコンジットホース内部にアルコールを流し込み、エアーブローして内部のワイヤー屑や銅粉を清掃する。', freq: 'semi-annual', image: 'image11.jpeg', category: 'A' },
            { id: 9, title: 'Blow air inside welder & boards', title_en: 'Blow Air Inside Welder & Boards', title_jp: '溶接機・基板内部のエアブロー清掃', desc: 'Remove panels and blow dry air to remove conductive dust from PCBs and power modules.', desc_en: 'Remove panels and blow dry air to remove conductive dust from PCBs and power modules.', desc_jp: '溶接機のカバーを取り外し、内部基板やパワー半導体に付着した鉄粉などの導電性粉塵を乾燥した圧縮空気で吹き飛ばす。', freq: 'annual', image: 'image12.jpeg', category: 'A' },
