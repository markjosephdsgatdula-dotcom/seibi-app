...
const AssetStore = (() => {
  ...
  const _defaultChecklistItems = [
    ...
    { id: 4, title: 'Check welding ground cable', title_en: 'Check Welding Ground Cable', title_jp: '溶接アース接続部の緩み点検', desc: 'Inspect grounding clamps and table connections for looseness.', desc_en: 'Inspect grounding clamps and table connections for looseness.', desc_jp: 'アースクランプおよび定盤の接続部に緩みがないか点検する。', freq: 'monthly', image: 'images/ground-cable.jpg', category: 'A' },
    ...
    { id: 7, title: 'Sand & oil welding table', title_en: 'Sand & Oil Welding Table', title_jp: '定盤・溶接台の清掃（研磨・防錆油塗布）', desc: 'Remove spatter with a buffer and apply anti-rust oil to the welding table.', desc_en: 'Remove spatter with a buffer and apply anti-rust oil to the welding table.', desc_jp: 'バフ研磨機でスパッタを除去し、溶接定盤に防錆油を塗布する。', freq: 'monthly', image: 'images/welding-table.jpg', category: 'A' },
